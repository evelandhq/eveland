...
- [路由与流量策略契约](/zh/docs/reference/routing)：Route Policy、两目标权重与 SessionBinding 规则
- [Agent Gateway 数据面设计](/zh/docs/reference/design/gateway)：网关不变量、Host 解析与反向代理安全性
- [缩容到零与冷激活机制](/zh/docs/reference/design/scale-to-zero)：Activation Lease、Idle 收割与生命周期管理
