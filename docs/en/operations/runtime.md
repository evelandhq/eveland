...
- **Engine injection**: During release compilation, Eveland automatically injects `@evelandhq/workflow-world@0.15.1` (superseding legacy `@workflow/world-postgres@5.0.0-beta.34`), delegating execution states strictly to the external dispatcher.
