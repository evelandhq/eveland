...
describe("Eve observer hook compatibility matrix", () => {
  ...
  test.each(compatibilityMatrix)(
    ...
    async ({ packageName }) => {
      ...
      // model-capture's integration is never wrapped — re-verified 2026-09-20
      // (the pinned expression matches 0.62.0 and 0.63.0 alike; 0.55.0 moved
      ...
      // 0.63.0 shipped runtime.js byte-identical to 0.62.0).
