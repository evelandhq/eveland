 ...
 * 0.45.0 emits v14, 0.45.1+ and 0.47.x emit v15 (0.46 -- also v15 -- is the
 * window's skipped line). v13 left with the 0.44 line.
 */
export const SUPPORTED_DISCOVERY_MANIFEST_VERSIONS: readonly number[] = [14, 15];
