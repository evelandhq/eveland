 ...
 * 0.62.x and 0.63.x both emit v15 (as did 0.50.x through 0.61.x -- 0.55 retired
 * on 2026-09-19, when 0.59/0.60/0.61 were skipped, and 0.58 on 2026-09-20).
 * 0.62.0 stopped writing the
 * optional `instrumentation` module reference without bumping the version; the
