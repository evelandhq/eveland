...
currently verifies `0.25.3`, `0.26.2`, and `0.27.12`. Eve 0.27.2+ may open an NDJSON stream with a blank byte and lets
...
query, response header, and NDJSON body across Web, API, and Gateway. Eve 0.27.12's registry commands are an
