...
> **Status: COMPLETED — historical record.** This one-time cutover was
> executed and merged on 2026-08-18 (`f1659437`). Fresh installs never run
> it: they start on the shared World with an external-only dispatcher.
> Post-cutover confirmation and cleanup live at
> `docs/en/operations/upgrades.md`. The document below is preserved
> unchanged as the historical operational record of how the cutover was
> performed and what its tooling enforced.
...
`.plans/2026-08-09-workflow-dispatcher-boot-recovery-handoff.md`.
