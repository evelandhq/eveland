        ...
        <div className="flex flex-wrap items-center gap-x-3 gap-y-1 border-b border-border px-4 py-2 text-xs">
          ...
          {scheduleRun.trigger === "cron" ? (
            <>
              ...
              <span className="font-mono text-muted-foreground">{scheduleRun.version.cron}</span>
            </>
          ) : null}
          <span className="text-muted-foreground">
          ...
          {scheduleRun.error ? <span className="text-destructive">{scheduleRun.error}</span> : null}
          <Link
