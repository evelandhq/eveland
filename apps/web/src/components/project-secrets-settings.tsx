...
export function ProjectSecretsSettings({
  ...
  async function submitEntry(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setDialogError(
        caught instanceof Error ? caught.message : "Environment entry could not be saved.",
      );
    } finally {
      setPending(false);
    }
  ...
  async function removeEntry(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setError(
        caught instanceof Error ? caught.message : "Environment entry could not be removed.",
      );
    } finally {
      setPending(false);
    }
                  ...
                  <TableCell colSpan={4}>
                    <Empty className="border-0 py-10">
                      <EmptyHeader>
                        ...
                        <EmptyDescription>
                          Add a variable or secret for this project&apos;s Agent runtime.
                        </EmptyDescription>
                      </EmptyHeader>
                    </Empty>
                  </TableCell>
                        ...
                        >
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>
                                This removes the runtime value and restarts live deployments so it
                                no longer applies.
                              </AlertDialogDescription>
                            </AlertDialogHeader>
            ...
            <FieldGroup>
              ...
              <Field>
                ...
                <Input
                  ...
                  placeholder={
                    draft.configured ? "Leave blank to keep the current value" : "Enter a value"
                  }
                  disabled={pending}
                />
                {draft.configured ? (
