...
export const PromptInputActionAddAttachments = ({
  ...
  const handleSelect: NonNullable<PromptInputActionAddAttachmentsProps["onSelect"]> = useCallback(
    (e) => {
      e.preventDefault();
...
export const PromptInputActionAddScreenshot = ({
  ...
  const handleSelect: NonNullable<PromptInputActionAddScreenshotProps["onSelect"]> = useCallback(
    async (event) => {
      onSelect?.(event);
