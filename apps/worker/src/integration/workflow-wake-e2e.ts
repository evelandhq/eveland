 ...
 * covered by `apps/workflow-dispatcher/src/dispatch-loop.integration.test.ts`
 ...
 *
 *   1. a project deploys on `@eveland/workflow-world` in `external` mode;
 ...
 * docs/design/workflow-world.md §16). Not a vitest file: it drives running
...
import { createWorld, ensureTenantPartitions, runMigrations } from "@eveland/workflow-world";
import { Pool } from "pg";
