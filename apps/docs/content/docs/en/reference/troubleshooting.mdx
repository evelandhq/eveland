...
Check collector health and the session's usage completeness. Eveland records only provider usage reported through Eve and never estimates missing values.
