...
Only the Agent Gateway reaches public wildcard Agent hosts. Raw Agent ports stay on loopback, and `/internal/*` remains service-authenticated and excluded from the public proxy.
