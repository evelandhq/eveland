...
获取 Tag，Checkout 目标 Stable Tag，安装 Frozen Lockfile 并应用版本化数据库 Migration。为 Dashboard、API、Agent Gateway 与 Worker 设置相同 Release Channel 和 Revision，再从同一 Checkout 重启。
