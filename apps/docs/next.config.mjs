...
export default withMDX({
  ...
  async redirects() {
    return [
      ...
      { source: "/docs/troubleshooting", destination: "/docs/reference/troubleshooting", permanent: true },
      { source: "/zh/docs/quick-start", destination: "/zh/docs/production", permanent: true },
      { source: "/zh/docs/concepts", destination: "/zh/docs/agents/releases-routing", permanent: true },
      { source: "/zh/docs/deploy", destination: "/zh/docs/agents/first-deployment", permanent: true },
      { source: "/zh/docs/operate", destination: "/zh/docs/operations/runtime", permanent: true },
      { source: "/zh/docs/architecture", destination: "/zh/docs/reference/architecture", permanent: true },
      { source: "/zh/docs/troubleshooting", destination: "/zh/docs/reference/troubleshooting", permanent: true },
